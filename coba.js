// =======Options START=======
var authConfig = {
  siteName: "Selamat menikmati", // 网站名称
  version: "1.1.2", // 程序版本
  theme: "acrou",
  // 强烈推荐使用自己的 client_id 和 client_secret
  client_id: "202264815644.apps.googleusercontent.com",
  client_secret: "X4Z3ca8xfWDb1Voo-F9a7ZxJ",
  refresh_token: "1//0dbUXUFtJu5VBCgYIARAAGA0SNwF-L9IrmcihtVPje9vSGqVetAutoEkZIMlllpBP1H6EyOjIv1AuhpOHt6V_zuojB7FWRTQKXzs", // 授权 token
  /**
